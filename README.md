...
### 3. ✨ 温暖启航寄语与动态轮播公告 (Motivational Quotes Carousel)
* **励志启航寄语轮播**：在应用启动后、用户尚未开始打字时，卡片将在专属 Apple 胶囊公告栏与主展区中**随机动态轮播**激励寄语及其地道英文译文与核心生词：
  * *“开始学习吧！”* · *“今天也要努力上哦！”*
  * *“你说过的，要改变世界”* · *“关注B站的北辰捡垃圾喵”*
  * *“我相信你只要,做什么都可以”* · *“勇敢去做”*
* **敲字即隐机制**：一旦监测到用户在任意软件中开始敲字输入，**公告寄语将自动永久隐匿且不再显示**，无缝切换为专注用户的打字翻译与词汇解析，极致纯净无打扰。
